...
def user_input_features():
    item = st.selectbox("Item", ['Bread', 'Scandivanian', 'Hot Chocolate', 'Jam', 'Cookies', 'Muffin', 'Coffee', 'Pastry', 'Medialuna', 'Tea', 'Tartine', 'Basket', 'Mineral Water', 'Farm House', 'Juice', 'Fudge', 'Ellas Kitchen Pouch', 'Victorian Sponge', 'Frittata', 'Hearty & Seasonal', 'Soup', 'Pick and Mix Bowis', 'Smoothies', 'Cake', 'Mighty Protein', 'Chicken sand', 'My-5 Fruit Shoot', 'Focaccia', 'Sandwich', 'Coke', 'Alfajores', 'Dulce de Leche', 'The BART', 'Empanadas', 'Keeping It Local', 'Chimichurri Oil', 'Truffles', 'Art Tray', 'Bowl Nic Pitt', 'Jammie Dodgers', 'Brownie', 'Tiffin', 'Olum & polenta', 'Polenta', 'The Nomad', 'Hack the stack', 'Bakewell', 'Lemon and coconut', 'Scone', 'Toast', 'Crepes', 'Truffles', 'Pintxos', 'Muesli', 'Vegan mincepie', 'Gingerbread syrup', 'Granola', 'Brioche and salami', 'Salad', 'Chicken Stew', 'Scone', 'Rasberry shortbread', 'Half slice Monster', 'Spanish Brunch', 'Baguette', 'Christmas common', 'Cherry me Dried fruit', 'Argentina Night', 'Nomad Bag', 'Drinking chocolate spoons', 'Vegan Feast', 'Tacos/Fajita', 'Afternoon with the baker'])
